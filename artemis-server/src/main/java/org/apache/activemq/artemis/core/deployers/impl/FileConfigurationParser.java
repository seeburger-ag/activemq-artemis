...
public final class FileConfigurationParser extends XMLConfigurationUtil {
   ...
   private void parseLockCoordinator(final Element lockCoordinatorElement, final Configuration mainConfig) throws Exception {
      ...
      String lockType = getString(lockCoordinatorElement, "type", null, NOT_NULL_OR_EMPTY);
      ...
      LockCoordinatorConfiguration lockCoordinatorConfiguration = new LockCoordinatorConfiguration(properties).setName(name).setLockId(lockId).setLockType(lockType).setCheckPeriod(checkPeriod);
